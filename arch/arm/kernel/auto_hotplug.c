...
/* Copyright (c) 2015, Jean Francis Dominique S. Mabalot <jmabalot@google.com>. All rights reserved.
 *
 * Ported to Xiaomi Mi3/Mi4 aka Cancro.
 * This will add another choice of a simple hotplug driver for the MSM8974. Disable current
 * Hotplug like MPDecsion to enable this driver.
 */
